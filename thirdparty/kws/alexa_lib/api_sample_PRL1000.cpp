...
int main(int argc, char **argv)
{
    ...
    PryonLiteError err = PryonLite_GetConfigAttributes(&engineConfig, &engineEventConfig, &configAttributes);
    ...
    err = PryonLite_Initialize(&engineConfig, &sHandle, handleEvent, &engineEventConfig, engineBuffer, sizeof(engineBuffer));
    ...
    err = PryonLiteWakeword_SetDetectionThreshold(sHandle.ww, NULL, detectionThreshold);
    ...
    while(1)
    {
        ...
        err = PryonLite_PushAudioSamples(&sHandle, samples, SAMPLES_PER_FRAME);
