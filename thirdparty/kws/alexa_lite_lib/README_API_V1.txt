...
=============================
There are two types of engines that support various types of models:

- "D" class (larger CPU/Mem footprint, better performance)
- "U" and "W*" class (smaller CPU/Mem footprint, lower performance)

If a binary contains a "-U" suffix, it only supports "U" and "W*" type models.
If the binary contains no suffix, it supports all types of models. Be sure to check
...
- Note on backwards compatibility:
    ...
    - All other features must use the version 2.x API
