...
##GSOUND:2  AMA:1  GFPS:2  OTA:1  TOTA:1
export SPP_SERVICE_NUM ?= 8
KBUILD_CPPFLAGS += -DSPP_SERVICE_NUM=$(SPP_SERVICE_NUM)

export BT_DISC_ACL_AFTER_AUTH_KEY_MISSING ?= 1
...
export APP_MIC_CAPTURE_LOOPBACK ?=0
ifeq ($(APP_MIC_CAPTURE_LOOPBACK),1)
KBUILD_CPPFLAGS += -DAPP_MIC_CAPTURE_LOOPBACK
endif
...
KBUILD_CPPFLAGS += -DCODEC_DAC_MULTI_VOLUME_TABLE
endif
...
ifeq ($(OTA_BOOT_USE_FLASH_NC_SECTION),1)
export OTA_APP_BOOT_INFO_SIZE ?= 0x1000
KBUILD_CPPFLAGS += -DOTA_BOOT_USE_FLASH_NC_SECTION
else
export OTA_APP_BOOT_INFO_SIZE ?= 0
endif

export LDS_SECTION_FLAGS := \
	-DOTA_APP_BOOT_INFO_SIZE=$(OTA_APP_BOOT_INFO_SIZE) \
