...
#define OTA_BOOTLOADER_PIN_CFG_NUM (1)
...
extern const struct HAL_KEY_GPIOKEY_CFG_T ota_bootloader_pin_cfg[OTA_BOOTLOADER_PIN_CFG_NUM];
extern const uint32_t programmer_op_wdt_timeout_ms;
