 ...
 * 
 */
typedef void (*app_gma_cmd_handler_t)(APP_GMA_CMD_CODE_E cmdCode, uint8_t* ptrParam, uint32_t paramLen,uint8_t device_id);
 ...
 * 
 */
typedef void (*app_gma_cmd_response_handler_t)(APP_GMA_CMD_RET_STATUS_E retStatus, uint8_t* ptrParam, uint32_t paramLen,uint8_t device_id);
