...
#if 0
static sdp_attribute_t VOICE_SPP_SdpAttributes2[] = {
    ...
    /* SPP service name*/
    SDP_ATTRIBUTE((AID_SERVICE_NAME + 0x0100), VOICE_SPP_ServiceName2),
};
#endif
...
void VOICE_SPP_RegisterSdpServices(uint8_t *service_id, btif_sdp_record_param_t *param)
{
    ...
    *service_id = RFCOMM_CHANNEL_AI_VOICE;
...
#ifdef UUID_128_ENABLE
    AI_SPP_TO_ADD(AI_SPEC_COMMON, VOICE_SPP_Register128UuidSdpServices);
#else
    AI_SPP_TO_ADD(AI_SPEC_COMMON, VOICE_SPP_RegisterSdpServices);
#endif
