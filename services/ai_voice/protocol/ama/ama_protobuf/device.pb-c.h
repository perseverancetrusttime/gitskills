...
typedef struct _FeatureProperties FeatureProperties;
typedef struct _DeviceFeatures DeviceFeatures;
typedef struct _GetDeviceFeatures GetDeviceFeatures;
...
struct  _DeviceInformation
{
  ...
  size_t n_associated_devices;
  uint32_t *associated_devices;
  size_t n_supported_speech_initiations;
  SpeechInitiationType *supported_speech_initiations;
  size_t n_supported_wakewords;
  char **supported_wakewords;
};
#define DEVICE_INFORMATION__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&device_information__descriptor) \
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0,NULL, (char *)protobuf_c_empty_string, 0, NULL, NULL, 0, 0,NULL, 0,NULL, 0,NULL }
...
struct  _FeatureProperties
{
  ProtobufCMessage base;
  uint32_t feature_id;
  uint32_t envelope_version;
};
#define FEATURE_PROPERTIES__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&feature_properties__descriptor) \
    , 0, 0 }


struct  _DeviceFeatures
{
  ProtobufCMessage base;
  uint32_t features;
  uint32_t device_attributes;
  size_t n_feature_properties;
  FeatureProperties **feature_properties;
};
#define DEVICE_FEATURES__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&device_features__descriptor) \
    , 0, 0, 0,NULL }


struct  _GetDeviceFeatures
{
  ProtobufCMessage base;
};
#define GET_DEVICE_FEATURES__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&get_device_features__descriptor) \
     }
...
typedef void (*NotifyDeviceInformation_Closure)
                 (const NotifyDeviceInformation *message,
                  void *closure_data);
typedef void (*FeatureProperties_Closure)
                 (const FeatureProperties *message,
                  void *closure_data);
typedef void (*DeviceFeatures_Closure)
                 (const DeviceFeatures *message,
                  void *closure_data);
typedef void (*GetDeviceFeatures_Closure)
                 (const GetDeviceFeatures *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor feature_properties__descriptor;
extern const ProtobufCMessageDescriptor device_features__descriptor;
extern const ProtobufCMessageDescriptor get_device_features__descriptor;
