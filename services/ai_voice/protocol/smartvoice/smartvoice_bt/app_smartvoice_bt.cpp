...
static const U8 SMARTVOICE_SPP_ProtoDescList[] = {
    ...
    SDP_UINT_8BIT(RFCOMM_CHANNEL_BES)
};
...
void SMARTVOICE_SPP_RegisterSdpServices(uint8_t *service_id, btif_sdp_record_param_t *param)
{
    /* Register 128bit UUID SDP Attributes */
    *service_id = RFCOMM_CHANNEL_BES;

    param->attrs = (sdp_attribute_t *)(&SMARTVOICE_SPP_SdpAttributes1[0]);
    param->attr_count = ARRAY_SIZE(SMARTVOICE_SPP_SdpAttributes1);
...
void SMARTVOICE_SPP_Register128UuidSdpServices(uint8_t *service_id, btif_sdp_record_param_t *param)
{
    /* Register 128bit UUID SDP Attributes */
    *service_id = RFCOMM_CHANNEL_BES;

    param->attrs = (sdp_attribute_t *)(&SMARTVOICE_SPP_128UuidSdpAttributes[0]);
    param->attr_count = ARRAY_SIZE(SMARTVOICE_SPP_128UuidSdpAttributes);
    param->COD = BTIF_COD_MAJOR_PERIPHERAL;
