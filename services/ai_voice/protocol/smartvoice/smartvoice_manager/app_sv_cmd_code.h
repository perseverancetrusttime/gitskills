 ...
 * 
 */
typedef void (*app_sv_cmd_handler_t)(APP_SV_CMD_CODE_E cmdCode, uint8_t* ptrParam, uint32_t paramLen, uint8_t device_id);
 ...
 * 
 */
typedef void (*app_sv_cmd_response_handler_t)(APP_SV_CMD_RET_STATUS_E retStatus, uint8_t* ptrParam, uint32_t paramLen, uint8_t device_id);
