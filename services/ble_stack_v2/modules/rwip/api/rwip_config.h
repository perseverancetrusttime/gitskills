...
#define BLE_MEM_MSG_RATIO  4
#elif __MUTLI_POINT_AI__
#define BLE_MEM_MSG_RATIO  2
#else
#define BLE_MEM_MSG_RATIO  1
#endif
/// Kernel Message Heap
#define RWIP_HEAP_MSG_SIZE     BLE_MEM_MSG_RATIO * (  BT_HEAP_MSG_SIZE_      + \
                                                 BLE_HEAP_MSG_SIZE_     + \
