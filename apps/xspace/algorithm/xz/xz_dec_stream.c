...
XZ_EXTERN struct xz_dec *xz_dec_init(enum xz_mode mode, uint32_t dict_max, uint8_t *xz_mem_pool, uint32_t xz_mem_pool_size)
{
    ...
    med_heap_init(xz_mem_pool, xz_mem_pool_size);
    /**add by lmzhang,20201218*/
