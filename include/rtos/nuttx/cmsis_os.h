...
memset(((osTimerDefEx_t*)&pTimer)->os_timer_cb,0,1*sizeof(osTimerAttr_t))
...
memset(&(((osMutexDefEx_t*)&pMutex)->os_mutex_def.mutex),0,1*sizeof(pthread_mutex_t))
